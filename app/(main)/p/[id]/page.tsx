    ...
    <div className="grow flex flex-col items-center mt-10 text-sm">
      <div className="h-[44px] sm:hidden">
        <div className="h-[44px] fixed top-0 left-0 w-screen border z-10 bg-white dark:bg-black flex">
          <Link href="/" className="py-3 px-4 text-xl font-semibold"><LeftChevron /></Link>
      ...
      <main className="flex max-w-[850px] h-[600px] pb-10">
        ...
        <section className="w-[355px] flex flex-col border dark:border-gray-800 border-[#dbdbdb] shrink-0">
          <div className="px-4 border-b dark:border-gray-800 border-[#dbdbdb]">
            ...
            <article>
              <div className="flex gap-1 items-center">
                ...
                <span className="text-[#a8a8a8]">
                  {getShortenedRelative(item.date)}
                </span>
              </div>
      ...
      <section className="border-t dark:border-gray-800 border-[#dbdbdb] w-[900px] pt-16">
        <h1 className="font-gray-500 mb-5">
          More posts from
          <Link href={`/${item.account}`} className="font-white font-bold">
            {" "}
            {item.account}
          </Link>
        </h1>
